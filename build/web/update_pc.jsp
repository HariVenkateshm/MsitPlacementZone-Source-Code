<%-- 
    Document   : update_pc
    Created on : May 29, 2017, 5:49:43 PM
    Author     : SaiDeva
--%>
...
<div class="main">
      <div class="one">
        <div class="register">
          <h3>Update Pc</h3>
          <form id="reg-form" action="Update_Pc_Servlet">
            <div>
              <label for="name" >Name</label>
              <input type="text" id="name" name="name" spellcheck="false" value="<%=pcname%>"/>
            </div>
            <div>
              <label for="name" >Roll No</label>
              <input type="text" id="name" name="rollno" spellcheck="false" value="<%=rollno%>"/>
            </div>
            <div>
