<%-- 
    Document   : delete_postjob
    Created on : May 30, 2017, 10:05:10 AM
    Author     : SaiDeva
--%>
...
<div class="main">
      <div class="one">
        <div class="register">
          <h3>Update Mentor</h3>
          <form id="reg-form" action="Delete_Postjob">
            <div>
            ...
            <div>
              <label></label>
              <input type="submit" value="Delete" id="create-account" class="button"/>
            </div>
          </form>
          </div>
        </div>
