 ...
 * @author SaiDeva
 */
@WebServlet(name = "Delete_Postjob", urlPatterns = {"/Delete_Postjob"})
public class Delete_Postjob extends HttpServlet {
...
//       Date myDate = formatter.parse(dateString);
        ...
        Query q=ss.createQuery("delete Postjobs where companyname= :cn"); 
