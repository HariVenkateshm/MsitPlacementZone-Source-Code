 ...
 * @author SaiDeva
 */
@WebServlet(name = "Delete_Pc", urlPatterns = {"/Delete_Pc"})
public class Delete_Pc extends HttpServlet {
...
//       Date myDate = formatter.parse(dateString);
        ...
        Query q=ss.createQuery("delete Pc where rollnumber= :rl"); 
        q.setParameter("rl",rollno);
