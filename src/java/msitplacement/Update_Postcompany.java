 ...
 * @author SaiDeva
 */
@WebServlet(name = "Update_Postcompany", urlPatterns = {"/Update_Postcompany"})
public class Update_Postcompany extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //about=ab.getBytes();
        ...
        System.out.println(Company_name +" "+jobd +" "+ab);
        SessionFactory sess=new Configuration().configure().buildSessionFactory();
        Session ss=sess.openSession();
        Transaction tr=ss.beginTransaction();  
        Query q=ss.createQuery("update Postcompany set companyname= :cn, jobdesc= :d,about= :vn where companyname= :cn");  
        q.setParameter("cn",Company_name);
        q.setParameter("d",jobd);  
        q.setParameter("vn",ab); 
