 ...
 * @author SaiDeva
 */
@WebServlet(name = "Update_Postjob", urlPatterns = {"/Update_Postjob"})
public class Update_Postjob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Date myDate = formatter.parse(dateString);
        ...
        Query q=ss.createQuery("update Postjobs set companyname= :cn, date= :d,venue= :vn where companyname= :cn");  
        q.setParameter("cn",c_name);
        q.setParameter("d",myDate);  
        q.setParameter("vn",venue); 
